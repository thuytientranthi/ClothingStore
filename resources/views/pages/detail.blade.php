                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            ...
                            <p class="available">Category: <span class="text-muted">{{$value->nameCategory}}</span></p>
                            ...
                            <!-- Add to Cart Form -->
                            <form class="cart clearfix mb-50 d-flex" action ="{{url("addToCart/{$value->id}")}}" method="post">
                                 {{ csrf_field() }}
                                <input type="hidden" name="product_id" value="{{$value->id}}">
                                <div class="quantity">
                                    <span class="qty-minus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 1 ) effect.value--;return false;"><i class="fas fa-minus" aria-hidden="true"></i></span>
                                    <input type="number" class="qty-text" id="qty" step="1" min="1" max="12" name="quantity" value="1">
                                    <span class="qty-plus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty )) effect.value++;return false;"><i class="fas fa-plus" aria-hidden="true"></i></span>
                                </div>
